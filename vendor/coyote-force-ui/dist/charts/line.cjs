...
function ChartLineDefault() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart" }),
...
function ChartLineLinear() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Linear" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
...
function ChartLineStep() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Step" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
...
function ChartLineMultiple() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Multiple" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex w-full items-start gap-2 text-sm", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "grid gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center gap-2 leading-none text-muted-foreground", children: "Showing total visitors for the last 6 months" })
    ] }) }) })
  ] });
}
var chartData5 = [
...
function ChartLineDots() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Dots" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
...
function ChartLineDotsColors() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Dots Colors" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
...
function ChartLineDotsCustom() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Custom Dots" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            RechartsPrimitive.Line,
            {
              ...
              dot: ({ cx, cy, payload }) => {
                if (cx == null || cy == null) {
                  return /* @__PURE__ */ jsxRuntime.jsx("g", {}, payload.month);
                }
                const r = 24;
                return /* @__PURE__ */ jsxRuntime.jsx(
                  lucideReact.GitCommitVertical,
                  {
                    x: cx - r / 2,
                    y: cy - r / 2,
                    width: r,
...
function ChartLineLabel() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Label" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
...
function ChartLineLabelCustom() {
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Custom Label" }),
      /* @__PURE__ */ jsxRuntime.jsx(CardDescription, { children: "January - June 2024" })
    ] }),
...
function ChartLineInteractive() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Card, { className: "py-4 sm:py-0", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { className: "flex flex-col items-stretch border-b p-0! sm:flex-row", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-1 flex-col justify-center gap-1 px-6 pb-3 sm:pb-0", children: [
        /* @__PURE__ */ jsxRuntime.jsx(CardTitle, { children: "Line Chart - Interactive" }),
...
exports.ChartLineDefault = ChartLineDefault;
exports.ChartLineDots = ChartLineDots;
exports.ChartLineDotsColors = ChartLineDotsColors;
exports.ChartLineDotsCustom = ChartLineDotsCustom;
exports.ChartLineInteractive = ChartLineInteractive;
exports.ChartLineLabel = ChartLineLabel;
exports.ChartLineLabelCustom = ChartLineLabelCustom;
exports.ChartLineLinear = ChartLineLinear;
exports.ChartLineMultiple = ChartLineMultiple;
exports.ChartLineStep = ChartLineStep;
