...
import { BarChart, CartesianGrid, XAxis, Bar, YAxis, LabelList, Rectangle, Cell } from 'recharts';
...
function ChartBarDefault() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig, children: /* @__PURE__ */ jsxs(BarChart, { accessibilityLayer: true, data: chartData, children: [
...
function ChartBarHorizontal() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Horizontal" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig2, children: /* @__PURE__ */ jsxs(
      BarChart,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(XAxis, { type: "number", dataKey: "desktop", hide: true }),
          /* @__PURE__ */ jsx(
            YAxis,
            {
              dataKey: "month",
          ...
          /* @__PURE__ */ jsx(Bar, { dataKey: "desktop", fill: "var(--color-desktop)", radius: 5 })
        ]
      }
    ) }) }),
    /* @__PURE__ */ jsxs(CardFooter, { className: "flex-col items-start gap-2 text-sm", children: [
...
function ChartBarMultiple() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Multiple" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig3, children: /* @__PURE__ */ jsxs(BarChart, { accessibilityLayer: true, data: chartData3, children: [
      /* @__PURE__ */ jsx(CartesianGrid, { vertical: false }),
      /* @__PURE__ */ jsx(
        XAxis,
        {
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          cursor: false,
          content: /* @__PURE__ */ jsx(ChartTooltipContent, { indicator: "dashed" })
        }
      ),
...
function ChartBarStacked() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Stacked + Legend" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig4, children: /* @__PURE__ */ jsxs(BarChart, { accessibilityLayer: true, data: chartData4, children: [
      /* @__PURE__ */ jsx(CartesianGrid, { vertical: false }),
      /* @__PURE__ */ jsx(
        XAxis,
        {
...
function ChartBarLabel() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Label" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig5, children: /* @__PURE__ */ jsxs(
      BarChart,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Bar, { dataKey: "desktop", fill: "var(--color-desktop)", radius: 8, children: /* @__PURE__ */ jsx(
            LabelList,
            {
              position: "top",
              offset: 12,
...
function ChartBarLabelCustom() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Custom Label" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig6, children: /* @__PURE__ */ jsxs(
      BarChart,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(XAxis, { dataKey: "desktop", type: "number", hide: true }),
          /* @__PURE__ */ jsx(
            ChartTooltip,
            {
              cursor: false,
          ...
          /* @__PURE__ */ jsxs(Bar, { dataKey: "desktop", fill: "var(--color-desktop)", radius: 4, children: [
            /* @__PURE__ */ jsx(
              LabelList,
              {
                dataKey: "month",
...
function ChartBarMixed() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Mixed" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig7, children: /* @__PURE__ */ jsxs(
      BarChart,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(XAxis, { dataKey: "visitors", type: "number", hide: true }),
          /* @__PURE__ */ jsx(
            ChartTooltip,
            {
              cursor: false,
          ...
          /* @__PURE__ */ jsx(Bar, { dataKey: "visitors", radius: 5 })
        ]
      }
    ) }) }),
    /* @__PURE__ */ jsxs(CardFooter, { className: "flex-col items-start gap-2 text-sm", children: [
...
function ChartBarActive() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Active" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig8, children: /* @__PURE__ */ jsxs(BarChart, { accessibilityLayer: true, data: chartData8, children: [
      /* @__PURE__ */ jsx(CartesianGrid, { vertical: false }),
      /* @__PURE__ */ jsx(
        XAxis,
        {
      ...
      /* @__PURE__ */ jsx(
        Bar,
        {
          ...
          strokeWidth: 2,
          radius: 8,
          shape: ({ index, ...props }) => index === ACTIVE_INDEX ? /* @__PURE__ */ jsx(
            Rectangle,
            {
              ...props,
              fillOpacity: 0.8,
...
function ChartBarNegative() {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Bar Chart - Negative" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "January - June 2024" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig9, children: /* @__PURE__ */ jsxs(BarChart, { accessibilityLayer: true, data: chartData9, children: [
      /* @__PURE__ */ jsx(CartesianGrid, { vertical: false }),
      /* @__PURE__ */ jsx(
        ChartTooltip,
        {
          cursor: false,
          content: /* @__PURE__ */ jsx(ChartTooltipContent, { hideLabel: true, hideIndicator: true })
        }
      ),
      /* @__PURE__ */ jsxs(Bar, { dataKey: "visitors", children: [
        /* @__PURE__ */ jsx(LabelList, { position: "top", dataKey: "month", fillOpacity: 1 }),
        chartData9.map((item) => /* @__PURE__ */ jsx(
          Cell,
          {
...
function ChartBarInteractive() {
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "py-0", children: [
    /* @__PURE__ */ jsxs(CardHeader, { className: "flex flex-col items-stretch border-b p-0! sm:flex-row", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col justify-center gap-1 px-6 pt-4 pb-3 sm:py-0!", children: [
...
export { ChartBarActive, ChartBarDefault, ChartBarHorizontal, ChartBarInteractive, ChartBarLabel, ChartBarLabelCustom, ChartBarMixed, ChartBarMultiple, ChartBarNegative, ChartBarStacked };
