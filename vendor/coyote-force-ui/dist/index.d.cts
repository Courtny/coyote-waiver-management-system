...
declare const buttonVariants: (props?: ({
    variant?: "link" | "destructive" | "primary" | "secondary" | "secondary-green" | "secondary-coral" | "ghost" | "destructive-solid" | null | undefined;
...
declare function CardTitle({ className, asChild, ...props }: React$1.ComponentProps<"h3"> & {
    asChild?: boolean;
}): react_jsx_runtime.JSX.Element;
...
declare function FormMessage({ className, children, ...props }: React$1.ComponentProps<"p">): react_jsx_runtime.JSX.Element | null;
...
declare function NativeSelectOption({ className, ...props }: React$1.ComponentProps<"option">): react_jsx_runtime.JSX.Element;
